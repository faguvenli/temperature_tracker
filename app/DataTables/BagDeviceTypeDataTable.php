...
class BagDeviceTypeDataTable extends DataTable
{
    /**
        ...
        return datatables()
            ...
            ->setRowAttr([
                'data-href' => function($data) {
                    return route('bag-device-types.edit', $data->id);
                }
            ]);
    }
     ...
     *
     * @param \App\Models\BagDeviceType $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(BagDeviceType $model)
    {
    ...
    public function html()
    {
        return $this->builder()
            ...
            ->setTableId('bagDeviceType-table')
    ...
    {
        return [
            Column::make('name')->title('Cihaz Tipi')
        ];
    }
    ...
    {
        return 'BagDeviceType_' . date('YmdHis');
    }
}
