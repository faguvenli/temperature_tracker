...
@section('content')
    ...
    <div class="row justify-content-center">
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    {!! Form::model($envDevice, ['route' => ['env-devices.update', $envDevice->id], 'method' => 'PATCH'])!!}

                    {!! Form::selectField('confirmed', 'Onay Durumu', $confirmValues, $envDevice->confirmed) !!}
                    {!! Form::selectField('alarm_active', 'Alarm Durumu', $alarmValues, $envDevice->alarm_active) !!}
                    {!! Form::selectField('region_id', 'Bölge', $regions, $envDevice->region_id) !!}
                    {!! Form::selectField('device_type', 'Cihaz Tipi', $envDeviceTypes, $envDevice->device_type) !!}
                    ...
                    <div class="alt_button_holder">
                        <button type="button" class="btn btn-danger delete_btn" data-route="{{ route('env-devices.destroy', $envDevice->id) }}">Sil</button>
