        ...
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item"><a href="{{ route('roles.index') }}">Yetkiler</a></li>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="alt_button_holder">
                        <button type="button" class="btn btn-danger delete_btn" data-route="{{ route('roles.destroy', $role->id) }}">Sil</button>
